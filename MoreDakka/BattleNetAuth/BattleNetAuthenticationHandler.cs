    ...
    public class BattleNetAuthenticationHandler : AuthenticationHandler<BattleNetAuthenticationOptions>
    {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                body.Add(new KeyValuePair<string, string>("scope", Uri.EscapeUriString(scope)));
                ...
                requestMessage.Headers.Authorization =
                    new AuthenticationHeaderValue("Basic",
                        Convert.ToBase64String(
                            System.Text.Encoding.ASCII.GetBytes(string.Format("{0}:{1}", Options.ClientId, Options.ClientSecret))));
                ...
                {
                    context.Identity.AddClaim(new Claim("urn:BattleNet:url", context.Link, XmlSchemaString, Options.AuthenticationType));
                }
